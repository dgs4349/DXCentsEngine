...
namespace FlashBang {
	...
	*/
	...
	static const std::map<std::string, SOUNDCONTAINER_ITEM_TYPE> SOUNDCONATINER_ITEM_TYPE_ARGS = {
		{"Container", SOUNDCONTAINER_ITEM_TYPE::CONTAINER},
		{"Schema", SOUNDCONTAINER_ITEM_TYPE::SCHEMA},
		{"Sound", SOUNDCONTAINER_ITEM_TYPE::SOUND},
		// SOUND will be implied if previous items do not match
	};
